package com.microsvc.flutter_inappwebview.types;
...
public class WebMessageChannel implements MethodChannel.MethodCallHandler {
  ...
  public WebMessageChannel(@NonNull String id, @NonNull InAppWebViewInterface webView) {
    this.id = id;
    this.channel = new MethodChannel(webView.getPlugin().messenger, "com.microsvc/flutter_inappwebview_v2_web_message_channel_" + id);
