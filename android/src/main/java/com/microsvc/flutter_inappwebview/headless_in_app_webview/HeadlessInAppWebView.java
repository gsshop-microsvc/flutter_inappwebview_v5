package com.microsvc.flutter_inappwebview.headless_in_app_webview;
...
import com.microsvc.flutter_inappwebview.in_app_webview.FlutterWebView;
import com.microsvc.flutter_inappwebview.types.Size2D;
...
public class HeadlessInAppWebView implements MethodChannel.MethodCallHandler {
  ...
  public HeadlessInAppWebView(@NonNull final InAppWebViewFlutterPlugin plugin, @NonNull String id, @NonNull FlutterWebView flutterWebView) {
    ...
    this.channel = new MethodChannel(plugin.messenger, "com.microsvc/flutter_headless_inappwebview_v2_" + id);
