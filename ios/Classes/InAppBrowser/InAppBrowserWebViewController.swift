...
public class InAppBrowserWebViewController: UIViewController, InAppBrowserDelegate, UIScrollViewDelegate, WKUIDelegate, UISearchBarDelegate {
    ...
    public override func loadView() {
        channel = FlutterMethodChannel(name: "com.microsvc/flutter_inappbrowser_v2_" + id, binaryMessenger: SwiftFlutterPlugin.instance!.registrar!.messenger())
        ...
        let pullToRefreshLayoutChannel = FlutterMethodChannel(name: "com.microsvc/flutter_inappwebview_v2_pull_to_refresh_" + id,
