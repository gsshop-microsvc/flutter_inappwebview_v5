...
class _InAppWebViewState extends State<InAppWebViewV2> {
  ...
  Widget build(BuildContext context) {
      ...
      return ValueListenableBuilder<bool>(
          ...
          builder: (context, state, child) {
            ...
            return PlatformViewLink(
              ...
              viewType: 'com.pichillilorenzo/flutter_inappwebview_v2',
              surfaceFactory: (
    ...
    return Text(
        '$defaultTargetPlatform is not yet supported by the flutter_inappwebview_v2 plugin');
  }
