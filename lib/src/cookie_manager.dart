...
///
///**NOTE for iOS below 11.0 (LIMITED SUPPORT!)**: in this case, almost all of the methods ([CookieManagerV2.deleteAllCookies] and [IOSCookieManagerV2.getAllCookies] are not supported!)
...
class CookieManagerV2 {
  ...
  static const MethodChannel _channel = const MethodChannel(
      'com.pichillilorenzo/flutter_inappwebview_v2_CookieManagerV2');

  CookieManagerV2._();

  ///Contains only iOS-specific methods of [CookieManagerV2].
  late IOSCookieManagerV2 ios;
  ...
  static CookieManagerV2 _init() {
    ...
    _instance!.ios = IOSCookieManagerV2.instance();
    return _instance!;
  }
...
class IOSCookieManagerV2 {
  static IOSCookieManagerV2? _instance;

  IOSCookieManagerV2._();

  ///Gets the [IOSCookieManagerV2] shared instance.
  static IOSCookieManagerV2 instance() {
    return (_instance != null) ? _instance! : _init();
  }

  static IOSCookieManagerV2 _init() {
    _instance = IOSCookieManagerV2._();
    return _instance!;
  }
